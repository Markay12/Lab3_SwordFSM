...
REM
REM Generated by Vivado on Tue Mar 15 17:47:29 -0700 2022
...
echo "xvlog --incr --relax -prj final_tb_vlog.prj"
call xvlog  --incr --relax -prj final_tb_vlog.prj -log xvlog.log
